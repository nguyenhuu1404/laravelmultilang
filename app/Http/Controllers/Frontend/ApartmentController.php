...
class ApartmentController extends Controller
{
    public function index($hometelId, $id){
        ...
        $data['otherApartments'] = Apartment::where('hometel_id', $apartment->hometel_id)->whereNotIn('id',[$id])->where('status', 1)->limit(3)->get();
        ...
        $data['posts'] = $apartment->posts()->limit(4)->get();
